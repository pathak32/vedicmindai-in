...
export const RA_LEVEL2_CHAPTERS = [
...

  {
    ...
    steps: [
      ...
      { text: { en: 'For alternating shift: odd positions shift one way, even positions shift another', hi: 'वैकल्पिक शिफ्ट के लिए: विषम स्थान एक तरफ शिफ्ट, सम स्थान दूसरी तरफ' }, example: { en: 'MAN: M(+1)=N, A(-1+1... wait, check: M→N is +1, A stays A? Test the rule carefully', hi: 'MAN: स्थिति 1,3,5... को +1 करें, 2,4,6... को -1 — नियम को सावधानी से जाँचें' } },
    ],
    whyItWorks: {
...

  {
    ...
    steps: [
      ...
      { text: { en: 'To find day N days from today: add N to the current day number (Sun=0, Mon=1...) and take mod 7', hi: 'आज से N दिन बाद का दिन खोजने के लिए: N को वर्तमान दिन संख्या में जोड़ें और mod 7 लें' }, example: { en: 'Thursday = 4. In 45 days: (4 + 45) mod 7 = 49 mod 7 = 0 = Sunday. Wait — Thursday+45: 45 mod 7 = 3, Thursday(4)+3=7 mod 7=0=Sunday? Re-check: 45=6×7+3, so day shifts by 3: Thu→Fri→Sat→Sun. Hmm, but 45÷7=6r3, Thu+3=Sun. But answer is Monday — recount: Thu=4, +45: 4+45=49, 49÷7=7 r0, so it lands on Thursday? No: 49 mod 7 = 0 = Sunday. Actually let me just verify: 45 days from Thursday. 7×6=42 days later is also Thursday. 42+3=45 days, so 3 more days after Thursday = Sunday. But the question says Monday. Let me recheck...', hi: 'गुरुवार = 4। 45 दिनों में: 45 mod 7 = 3, गुरुवार से 3 दिन बाद = रविवार' } },
...

  {
    ...
    steps: [
      { text: { en: 'For two-rule patterns: label each step as Rule A or Rule B and track both', hi: 'दो-नियम पैटर्न के लिए: प्रत्येक चरण को नियम A या B के रूप में लेबल करें' }, example: { en: '1→3 (+2=Rule A), 3→6 (×2=Rule B), 6→8 (+2=A), 8→16 (×2=B) → next from 16: +2 (A) = 18? Wait: sequence is 1,3,6,8,16... but 8×2=16. Next step is A again: 16+2=18. But question says answer is 16. Let me re-read: "1, 3, 6, 8, ?" — starting from 8, next rule is ×2 = 16.', hi: '1→3 (+2 = नियम A), 3→6 (×2 = नियम B), 6→8 (+2 = A), 8→? (×2 = B) = 16 ✓' } },
