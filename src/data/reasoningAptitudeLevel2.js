...
export const RA_LEVEL2_QUESTIONS = [
  ...
  { chapter: 'analogies-l2', prompt: 'Author is to Novel as Composer is to ?', options: ['Symphony', 'Concert', 'Instrument'], answer: 'Symphony', difficulty: 'medium' },
  { chapter: 'analogies-l2', prompt: 'Marathon is to Running as Regatta is to ?', options: ['Rowing', 'Swimming', 'Cycling'], answer: 'Rowing', difficulty: 'hard' },
  { chapter: 'analogies-l2', prompt: 'Paw is to Cat as Hoof is to ?', options: ['Horse', 'Dog', 'Cow'], answer: 'Horse', difficulty: 'medium' },
  { chapter: 'analogies-l2', prompt: 'Coward is to Bravery as Miser is to ?', options: ['Generosity', 'Money', 'Fear'], answer: 'Generosity', difficulty: 'hard' },
  { chapter: 'analogies-l2', prompt: 'Earthquake is to Seismograph as Heart is to ?', options: ['ECG', 'Stethoscope', 'X-Ray'], answer: 'ECG', difficulty: 'hard' },
  { chapter: 'analogies-l2', prompt: 'Microscope is to Small as Telescope is to ?', options: ['Distant', 'Large', 'Dark'], answer: 'Distant', difficulty: 'medium' },
  { chapter: 'analogies-l2', prompt: 'Carpenter is to Wood as Mason is to ?', options: ['Bricks', 'Steel', 'Glass'], answer: 'Bricks', difficulty: 'medium' },
  { chapter: 'analogies-l2', prompt: 'Hunger is to Food as Thirst is to ?', options: ['Water', 'Sleep', 'Rest'], answer: 'Water', difficulty: 'easy' },
  ...
  { chapter: 'blood-relations-l2', prompt: 'Pointing to a man, a woman says "His mother is the only daughter of my mother." How is the woman related to the man?', options: ['Mother', 'Aunt', 'Sister'], answer: 'Mother', difficulty: 'hard' },
  { chapter: 'blood-relations-l2', prompt: 'A + B means A is the father of B. A – B means A is the mother of B. If P + Q – R, how is P related to R?', options: ['Grandfather', 'Father', 'Uncle'], answer: 'Grandfather', difficulty: 'hard' },
  { chapter: 'blood-relations-l2', prompt: 'If Ravi\'s father is Suresh\'s son, how is Suresh related to Ravi?', options: ['Grandfather', 'Uncle', 'Father'], answer: 'Grandfather', difficulty: 'medium' },
  { chapter: 'blood-relations-l2', prompt: 'Anita says "That girl is the wife of the grandson of my mother." Who is Anita to the girl?', options: ['Mother-in-law', 'Aunt', 'Grandmother-in-law'], answer: 'Mother-in-law', difficulty: 'hard' },
  { chapter: 'blood-relations-l2', prompt: 'Neha is the only child of Mr. and Mrs. Sharma. Neha\'s son refers to Mr. Sharma as ?', options: ['Maternal grandfather', 'Paternal grandfather', 'Uncle'], answer: 'Maternal grandfather', difficulty: 'medium' },
  { chapter: 'blood-relations-l2', prompt: 'Introducing a man, a woman says "He is the brother of my uncle\'s only daughter." How is the man related to the woman?', options: ['Cousin', 'Brother', 'Uncle'], answer: 'Cousin', difficulty: 'hard' },
  { chapter: 'blood-relations-l2', prompt: 'A man says "The father of this girl is the only son of my grandfather." How is the man related to the girl?', options: ['Father', 'Uncle', 'Brother'], answer: 'Uncle', difficulty: 'hard' },
  { chapter: 'blood-relations-l2', prompt: 'My mother\'s brother\'s son is my ?', options: ['Cousin', 'Nephew', 'Brother'], answer: 'Cousin', difficulty: 'medium' },
